        ...
        <div className="col-lg-12">
          <div className="overview-details">
            ...
            <p className="overview-summery">
              ...
              recognizing that complex challenges such as economic security,
              human rights, or climate sustainability require multifaceted
              solutions. We tailor a unique blend of advocacy, collaboration,
              investment, philanthropy, policy development, and innovative
              business practices to facilitate progress.
            </p>
            ...
            <p className="overview-summery column-lg-2">
              ABA is dedicated to empowering individuals with creative ideas.
              Our platform enables millions — from local artists and
              entrepreneurs to global business leaders — to share their stories
              and establish a compelling online presence. The Cambridge office
              is home to our Risk Management Practice, where we ensure the safe
              operation of complex critical systems, foster safety leadership,
              manage risk in high-hazard industries, and provide comprehensive
              risk assessments. Our expertise spans various sectors, including
              upstream and downstream oil and gas, rail and road transportation,
              construction, and gas utilities and distribution. With offices in
              Cambridge, UK, and Milan, Italy, we operate globally across
