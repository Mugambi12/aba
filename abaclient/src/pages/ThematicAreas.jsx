...
const ThematicAreas = () => {
  ...
  return (
    <>
      <Navbar />
      <PageHeader
        backgroundImage={data[0].BgImgHeader}
        title={data[0].title}
        focus={data[0].focus}
      />
      ...
      <Headings
        backgroundImage={data[1].BgImgHPR}
        title={data[1].title}
        focus={data[1].focus}
      />
      ...
      <Headings
        backgroundImage={data[2].BgImgSC}
        title={data[2].title}
        focus={data[2].focus}
      />
      ...
      <Headings
        backgroundImage={data[3].BgImgCEE}
        title={data[3].title}
        focus={data[3].focus}
      />
      ...
      <Headings
        backgroundImage={data[4].BgImgCCMA}
        title={data[4].title}
        focus={data[4].focus}
      />
      ...
      <Headings
        backgroundImage={data[5].BgImgSUNR}
        title={data[5].title}
        focus={data[5].focus}
      />
      ...
      <Headings
        backgroundImage={data[6].BgImgPAG}
        title={data[6].title}
        focus={data[6].focus}
      />
